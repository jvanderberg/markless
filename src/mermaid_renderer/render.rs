use crate::mermaid_renderer::config::LayoutConfig;
#[cfg(feature = "png")]
use crate::mermaid_renderer::config::RenderConfig;
use crate::mermaid_renderer::layout::{
...
pub fn render_svg(layout: &Layout, theme: &Theme, config: &LayoutConfig) -> String {
    ...
    let state_font_size = if layout.kind == crate::mermaid_renderer::ir::DiagramKind::State {
    ...
    let (width, height, viewbox_x, viewbox_y, viewbox_width, viewbox_height) =
        ...
        } else if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Requirement {
        ...
        } else if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Mindmap {
    ...
    let is_state = layout.kind == crate::mermaid_renderer::ir::DiagramKind::State;
    let is_class = layout.kind == crate::mermaid_renderer::ir::DiagramKind::Class;
    let is_pie = layout.kind == crate::mermaid_renderer::ir::DiagramKind::Pie;
    ...
    if layout.error.is_none() {
            ...
            && config.mindmap.use_max_width
        {
            ...
            height_attr.clear();
            style_attr = format!(" style=\"max-width: {:.3}px;\"", viewbox_width);
        } else if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Pie
    ...
    if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Architecture {
        svg.push_str(&render_architecture(layout, theme, config, &color_ids));
        svg.push_str("</svg>");
        return svg;
    }

    if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Radar {
        svg.push_str(&render_radar(layout, theme, config));
        svg.push_str("</svg>");
        return svg;
    }

    if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Requirement {
    ...
    let overlay_flowchart = layout.kind == crate::mermaid_renderer::ir::DiagramKind::Flowchart;
    ...
    if is_sequence {
        ...
        let base_edge_width = match layout.kind {
            ...
            | crate::mermaid_renderer::ir::DiagramKind::Er => 1.0,
            _ => 2.0,
        };
        for (idx, edge) in layout.edges.iter().enumerate() {
            ...
            let (mut dash, mut stroke_width) = match edge.style {
                crate::mermaid_renderer::ir::EdgeStyle::Solid => (String::new(), base_edge_width),
                crate::mermaid_renderer::ir::EdgeStyle::Dotted => {
                    ("stroke-dasharray=\"2\"".to_string(), base_edge_width)
                }
                crate::mermaid_renderer::ir::EdgeStyle::Thick => (String::new(), 3.5),
            };
            ...
            let marker_end = if edge.arrow_end && !overlay_flowchart {
                match layout.kind {
                    ...
                    crate::mermaid_renderer::ir::DiagramKind::Class => match edge.arrow_end_kind {
                        Some(crate::mermaid_renderer::ir::EdgeArrowhead::OpenTriangle) => {
                            format!("marker-end=\"url(#arrow-class-open-{marker_id})\"")
                        }
                        Some(crate::mermaid_renderer::ir::EdgeArrowhead::ClassDependency) => {
            ...
            if let Some((x, y, label)) = label_positions.get(&idx).and_then(|v| v.clone()) {
                let (pad_x, pad_y, fill_opacity, stroke_opacity) = match layout.kind {
                    crate::mermaid_renderer::ir::DiagramKind::State => (3.0, 1.6, 0.7, 0.25),
                    crate::mermaid_renderer::ir::DiagramKind::Flowchart => (4.5, 2.2, 0.95, 0.45),
                    _ => (4.0, 2.0, 0.85, 0.35),
                };
                let label_scale = if layout.kind == crate::mermaid_renderer::ir::DiagramKind::State
                {
                ...
                if layout.kind == crate::mermaid_renderer::ir::DiagramKind::State {
                    svg.push_str(&text_block_svg_with_font_size(
                        x,
                        y,
                        &label,
            ...
            let (endpoint_pad_x, endpoint_pad_y, endpoint_fill_opacity, endpoint_stroke_opacity) =
                match layout.kind {
                    crate::mermaid_renderer::ir::DiagramKind::State => (2.6, 1.4, 0.7, 0.25),
                    crate::mermaid_renderer::ir::DiagramKind::Flowchart => (3.4, 1.8, 0.95, 0.45),
                    crate::mermaid_renderer::ir::DiagramKind::Class => (3.2, 1.6, 0.9, 0.4),
                    _ => (3.0, 1.6, 0.85, 0.35),
                };
    ...
    if !is_sequence {
        let mut nodes_to_draw: Vec<&crate::mermaid_renderer::layout::NodeLayout> =
            if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Treemap {
                let mut nodes: Vec<&crate::mermaid_renderer::layout::NodeLayout> =
        ...
        for node in nodes_to_draw.drain(..) {
            ...
            if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Er {
            ...
            if layout.kind != crate::mermaid_renderer::ir::DiagramKind::Er {
                let divider_line_height =
                    if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Class {
            ...
            if !hide_label {
                let label_svg = if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Treemap
                {
                ...
                } else if layout.kind == crate::mermaid_renderer::ir::DiagramKind::Er {
                ...
                } else if layout.kind == crate::mermaid_renderer::ir::DiagramKind::State {
...
fn render_radar(layout: &Layout, theme: &Theme, _config: &LayoutConfig) -> String {
    ...
    fn parse_series(
        node: &crate::mermaid_renderer::layout::NodeLayout,
...
fn render_quadrant(
    layout: &crate::mermaid_renderer::layout::QuadrantLayout,
    theme: &Theme,
    config: &LayoutConfig,
) -> String {
    let mut svg = String::new();
...
fn render_gantt(
    layout: &crate::mermaid_renderer::layout::GanttLayout,
    theme: &Theme,
    config: &LayoutConfig,
) -> String {
    let mut svg = String::new();
...
fn render_xychart(
    layout: &crate::mermaid_renderer::layout::XYChartLayout,
    theme: &Theme,
    config: &LayoutConfig,
) -> String {
    let mut svg = String::new();
...
fn render_timeline(
    layout: &crate::mermaid_renderer::layout::TimelineLayout,
    theme: &Theme,
    config: &LayoutConfig,
) -> String {
    let mut svg = String::new();
...
fn render_gitgraph(gitgraph: &GitGraphLayout, theme: &Theme, config: &LayoutConfig) -> String {
    ...
    if gg.show_branches {
        for branch in &gitgraph.branches {
            let (x1, y1, x2, y2) = match gitgraph.direction {
                crate::mermaid_renderer::ir::Direction::TopDown => {
                    (branch.pos, gg.default_pos, branch.pos, gitgraph.max_pos)
                }
                crate::mermaid_renderer::ir::Direction::BottomTop => {
    ...
    for commit in &gitgraph.commits {
        ...
        match commit_symbol_type {
            crate::mermaid_renderer::ir::GitGraphCommitType::Highlight => {
            ...
            crate::mermaid_renderer::ir::GitGraphCommitType::CherryPick => {
                svg.push_str(&format!(
            ...
            _ => {
                let radius = if commit.commit_type
                ...
                if commit_symbol_type == crate::mermaid_renderer::ir::GitGraphCommitType::Merge {
                    svg.push_str(&format!(
                        "<circle cx=\"{:.2}\" cy=\"{:.2}\" r=\"{:.2}\" fill=\"{}\" stroke=\"{}\"/>",
                        commit.x,
                        commit.y,
                ...
                if commit_symbol_type == crate::mermaid_renderer::ir::GitGraphCommitType::Reverse {
...
fn render_c4_shape(
    ...
    match shape.kind {
        crate::mermaid_renderer::ir::C4ShapeKind::SystemDb
        ...
        crate::mermaid_renderer::ir::C4ShapeKind::SystemQueue
        ...
        )
    {
        let icon = match shape.kind {
            crate::mermaid_renderer::ir::C4ShapeKind::ExternalPerson => C4_EXTERNAL_PERSON_ICON,
            crate::mermaid_renderer::ir::C4ShapeKind::Person => C4_PERSON_ICON,
            _ => C4_PERSON_ICON,
        };
        svg.push_str(&format!(
...
fn render_c4_rel(
    ...
    if straight {
        ...
        if rel.kind != crate::mermaid_renderer::ir::C4RelKind::RelBack {
            attrs.push_str(" marker-end=\"url(#arrowhead)\"");
        }
        if matches!(
            rel.kind,
            crate::mermaid_renderer::ir::C4RelKind::BiRel
                | crate::mermaid_renderer::ir::C4RelKind::RelBack
        ) {
...
fn c4_shape_colors(
    ...
    match kind {
        ...
        crate::mermaid_renderer::ir::C4ShapeKind::System => {
...
fn c4_shape_font_weight(
    ...
    match kind {
        crate::mermaid_renderer::ir::C4ShapeKind::Person => &conf.person_font_weight,
        crate::mermaid_renderer::ir::C4ShapeKind::ExternalPerson => {
            &conf.external_person_font_weight
        }
        crate::mermaid_renderer::ir::C4ShapeKind::System => &conf.system_font_weight,
        crate::mermaid_renderer::ir::C4ShapeKind::SystemDb => &conf.system_db_font_weight,
        crate::mermaid_renderer::ir::C4ShapeKind::SystemQueue => &conf.system_queue_font_weight,
        crate::mermaid_renderer::ir::C4ShapeKind::ExternalSystem => {
            &conf.external_system_font_weight
        }
        crate::mermaid_renderer::ir::C4ShapeKind::ExternalSystemDb => {
        ...
        crate::mermaid_renderer::ir::C4ShapeKind::Container => &conf.container_font_weight,
        crate::mermaid_renderer::ir::C4ShapeKind::ContainerDb => &conf.container_db_font_weight,
        crate::mermaid_renderer::ir::C4ShapeKind::ContainerQueue => {
            &conf.container_queue_font_weight
        }
        crate::mermaid_renderer::ir::C4ShapeKind::ExternalContainer => {
        ...
        crate::mermaid_renderer::ir::C4ShapeKind::Component => &conf.component_font_weight,
        crate::mermaid_renderer::ir::C4ShapeKind::ComponentDb => &conf.component_db_font_weight,
        crate::mermaid_renderer::ir::C4ShapeKind::ComponentQueue => {
            &conf.component_queue_font_weight
        }
        crate::mermaid_renderer::ir::C4ShapeKind::ExternalComponent => {
...
fn compute_edge_label_positions(
    edges: &[EdgeLayout],
    nodes: &std::collections::BTreeMap<String, crate::mermaid_renderer::layout::NodeLayout>,
    subgraphs: &[crate::mermaid_renderer::layout::SubgraphLayout],
...
fn link_attrs(link: &crate::mermaid_renderer::ir::NodeLink) -> String {
...
fn edge_decoration_svg(
    point: (f32, f32),
    angle_deg: f32,
    decoration: crate::mermaid_renderer::ir::EdgeDecoration,
    stroke: &str,
    stroke_width: f32,
    at_start: bool,
) -> String {
    ...
    if matches!(
        decoration,
        crate::mermaid_renderer::ir::EdgeDecoration::Diamond
            | crate::mermaid_renderer::ir::EdgeDecoration::DiamondFilled
    ) && !at_start
    {
        angle += 180.0;
    }
    ...
    let shape = match decoration {
        crate::mermaid_renderer::ir::EdgeDecoration::Circle => format!(
            "<circle cx=\"0\" cy=\"0\" r=\"5\" fill=\"none\" stroke=\"{}\" stroke-width=\"{}\"/>",
            stroke, stroke_width
        ),
        crate::mermaid_renderer::ir::EdgeDecoration::Cross => format!(
        ...
        crate::mermaid_renderer::ir::EdgeDecoration::CrowsFootOne => format!(
            "<path d=\"M 0 -6 L 0 6 M 5 -6 L 5 6\" fill=\"none\" stroke=\"{}\" stroke-width=\"{}\"{join}/>",
            stroke, stroke_width
        ),
        crate::mermaid_renderer::ir::EdgeDecoration::CrowsFootZeroOne => format!(
        ...
        crate::mermaid_renderer::ir::EdgeDecoration::CrowsFootMany => format!(
            "<path d=\"M 0 -6 L 0 6 M 0 0 L 8 -6 M 0 0 L 8 6\" fill=\"none\" stroke=\"{}\" stroke-width=\"{}\"{join}/>",
            stroke, stroke_width
        ),
        crate::mermaid_renderer::ir::EdgeDecoration::CrowsFootZeroMany => format!(
...
fn shape_svg(
    ...
    let h = node.height;
    match node.shape {
        crate::mermaid_renderer::ir::NodeShape::Rectangle => format!(
        ...
        crate::mermaid_renderer::ir::NodeShape::ForkJoin => format!(
        ...
        crate::mermaid_renderer::ir::NodeShape::ActorBox => format!(
            "<rect x=\"{:.2}\" y=\"{:.2}\" width=\"{:.2}\" height=\"{:.2}\" rx=\"3\" ry=\"3\" fill=\"{}\" stroke=\"{}\" stroke-width=\"{}\"{dash}{join}/>",
            x,
            y,
            w,
        ...
        | crate::mermaid_renderer::ir::NodeShape::DoubleCircle => {
            ...
            let (circle_fill, circle_stroke) = if is_state_start {
                ...
                if node.shape == crate::mermaid_renderer::ir::NodeShape::Circle {
                    (
                        theme.primary_text_color.as_str(),
                        theme.primary_text_color.as_str(),
                    )
            ...
            if node.shape == crate::mermaid_renderer::ir::NodeShape::DoubleCircle {
                let r2 = r - 4.0;
                if r2 > 0.0 {
        ...
        crate::mermaid_renderer::ir::NodeShape::Stadium => format!(
            "<rect x=\"{:.2}\" y=\"{:.2}\" width=\"{:.2}\" height=\"{:.2}\" rx=\"{:.2}\" ry=\"{:.2}\" fill=\"{}\" stroke=\"{}\" stroke-width=\"{}\"{dash}{join}/>",
            x,
            y,
            w,
        ...
        crate::mermaid_renderer::ir::NodeShape::RoundRect => format!(
        ...
        | crate::mermaid_renderer::ir::NodeShape::ParallelogramAlt => {
            let offset = w * 0.18;
            let (p1, p2, p3, p4) =
                if node.shape == crate::mermaid_renderer::ir::NodeShape::Parallelogram {
                    (
                        (x + offset, y),
                        (x + w, y),
                        (x + w - offset, y + h),
        ...
        | crate::mermaid_renderer::ir::NodeShape::TrapezoidAlt => {
            let offset = w * 0.18;
            let (p1, p2, p3, p4) =
                if node.shape == crate::mermaid_renderer::ir::NodeShape::Trapezoid {
                    (
                        (x + offset, y),
                        (x + w - offset, y),
                        (x + w, y + h),
...
mod tests {
    ...
    use crate::mermaid_renderer::layout::compute_layout;
